...
KPN Test 1
    ...
    Mouse Down    xpath=(//a[contains(@href, 'javascript:void(0);')])[3]
    Mouse Up    xpath=(//a[contains(@href, 'javascript:void(0);')])[3]
    Unselect Frame
    Wait Until Keyword Succeeds    16 sec    0.5 sec    Select Frame    id:iFrameResizer1
